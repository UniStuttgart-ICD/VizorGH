...
[[`Publication`](https://doi.org/10.52842%2Fconf.caadria.2022.2.141)] [[`BibTeX`](#how-to-cite-this-work)]
...
Three sample files are available in the [example](./Examples/) folder. They provide blueprints for scene setup, human-human, and human-robot collaboration workflows. Each sample file builds on the previous one, so it's recommended to go through them one after the other.
